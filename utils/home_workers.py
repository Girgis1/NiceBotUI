...
Provides QThread helpers to run long-running home operations off the UI
thread so the interface remains responsive during robot movements.
"""
...
class HomeProcessWorker(QThread):
    ...
    def run(self) -> None:  # type: ignore[override]
        ...
        except Exception as exc:  # pragma: no cover - defensive: subprocess errors
