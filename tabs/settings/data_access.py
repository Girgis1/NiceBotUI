...
class SettingsDataAccessMixin:
    ...
    def load_settings(self):
        ...
        self.cam_aux_edit.setText(str(aux_cam.get("index_or_path", "/dev/video5")))
    ...
    def save_settings(self):
        ...
        # Cameras
        cameras = config.setdefault("cameras", {"front": {}, "wrist": {}, "aux": {}})
        cameras.setdefault("front", {})
        cameras.setdefault("wrist", {})
        cameras.setdefault("aux", {})
        ...
        cameras["aux"].update({
            "index_or_path": self.cam_aux_edit.text(),
            "width": self.cam_width_spin.value(),
            "height": self.cam_height_spin.value(),
            "fps": self.cam_fps_spin.value(),
        })
    ...
    def reset_defaults(self):
        ...
        self.cam_aux_edit.setText("/dev/video5")
