...
class CameraPanelMixin:
    ...
    def create_camera_tab(self) -> QWidget:
        ...
        self.cam_aux_edit = QLineEdit("/dev/video5")
        ...
        try:
            ...
            if dialog.exec() == QDialog.Accepted:
                ...
                if selected_cam:
                    ...
                    selected_target = assign_group.checkedId()
                    if selected_target == 0:
                        self.cam_front_edit.setText(camera_path)
                        self.camera_front_status = "online"
                        circle = self.camera_status_circles.get("front")
                        if circle:
                            self.update_status_circle(circle, "online")
                        ...
                        circle = self.camera_status_circles.get("wrist")
                        if circle:
                            self.update_status_circle(circle, "online")
                        if self.device_manager:
                        ...
                        circle = self.camera_status_circles.get("aux")
                        if circle:
                            self.update_status_circle(circle, "online")
                        if self.device_manager:
