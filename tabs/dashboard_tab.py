...
This module now delegates camera, execution, home, and state logic to
specialised mixins under :mod:`tabs.dashboard` to keep the file manageable.
"""
...
class DashboardTab(
    ...
    """Main dashboard for robot control."""
    ...
    def __init__(self, config: dict, parent=None, device_manager=None):
        ...
        self.worker = None
        self.execution_worker = None  # Unified execution worker
        ...
        self._home_arms_queue: List[Dict] = []
    ...
    def init_ui(self):  # noqa: C901 - large but organised
    ...
    def validate_config(self):
        ...
        Status indicators are now managed by the device manager; this method is kept
