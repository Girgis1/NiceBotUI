...
> **Update (2025-02-15)**: The YOLO-based hand safety monitor referenced in this plan has been fully removed from the current Jetson build to prioritise stability. Any references below to `safety/hand_safety.py` now apply only to historical context.
