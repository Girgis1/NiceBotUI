...
│  │      MODEL SETUP                │ │  ← 80px
│  │  Model: [___________ ▼]         │ │
│  │  Episodes: [50] Time: [30s]     │ │
│  │  [CREATE NEW] [LOAD EXISTING]   │ │
│  └─────────────────────────────────┘ │
├─────────────────────────────────────┤
│  ┌─────────────────────────────────┐ │
│  │    EPISODE NAVIGATION           │ │  ← 100px
│  │  ◀️ PREV      [RECORDING]     ▶️ NEXT │ │
│  │  EPISODE 1/50  [00:00 / 00:30]   │ │
│  │  [START EPISODE] [SAVE] [DISCARD] │ │
│  └─────────────────────────────────┘ │
├─────────────────────────────────────┤
│  ┌─────────────────────────────────┐ │
│  │      RECORDING STATUS           │ │  ← 100px
│  │                                 │ │
│  │  📹 RECORDING: pick_and_place   │ │
│  │  Timer: 00:15 / 00:30           │ │
│  │  Progress: ████░░░░░ 23/50      │ │
│  │                                 │ │
│  └─────────────────────────────────┘ │
├─────────────────────────────────────┤
│  ┌─────────────────┐ ┌─────────────┐ │
│  │   DATASET       │ │  TRAINING   │ │  ← 120px
│  │   STATUS        │ │  STATUS     │ │
│  │                 │ │  (DISABLED) │ │
│  │ Episodes: 23    │ │  [SYNC TO   │ │
│  │ Size: 2.4GB     │ │   PC]       │ │
│  │ Status: Ready   │ │  [▶️ TRAIN   │ │
│  │                 │ │   REMOTE]   │ │
│  └─────────────────┘ └─────────────┘ │
└─────────────────────────────────────┘ ← 600px TOTAL
```
